...
<head>
  ...
  <!-- Ionicons -->
  <link rel="stylesheet" href="{{ asset('public/https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css')}}">
  ...
  <link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700" rel="stylesheet">
   ...
   <link rel="stylesheet" href="{{ asset('public/dist/css/datatables.css')}}">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="{{asset('public/admink')}}"  class="d-block">На головну!</a>
        </div>
      </div>
