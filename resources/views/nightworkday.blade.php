    ...
    <div class="card card-info">
        ...
        <!-- /.card-header -->
         <div class="card-body">
                   ...
                   {!! Form::label('fio', 'ФІО хворого') !!}
                        {!! Form::text('fio', null, ['class' => 'col-3']) !!}
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::label('work', 'Що зроблено') !!}
                        {!! Form::textarea('work', null, ['class' => 'form-control']) !!}
                   </div>
      
                     <div class="form-group">
    {!! Form::label('station', 'Місце чергування') !!}
{!! Form::text('station', null, ['class' => 'col-4']) !!}
