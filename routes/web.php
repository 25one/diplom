...
Route::post('/admink.user_upload', 'UploadoneController@getDetails')->name('admink.user_upload');

Route::post('/admink.upload_profile', 'UploadoneController@setDetails')->name('admink.upload_profile');
