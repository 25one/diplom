...
<head>
  ...
  <!-- Ionicons -->
  <link rel="stylesheet" href="<?php echo e(asset('public/https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css')); ?>">
  ...
  <link rel="stylesheet" href="<?php echo e(asset('public/dist/css/adminlte.css')); ?>">
  <!-- overlayScrollbars -->
  ...
  <link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700" rel="stylesheet">
   ...
   <link rel="stylesheet" href="<?php echo e(asset('public/dist/css/datatables.css')); ?>">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="<?php echo e(asset('public/admink')); ?>"  class="d-block">На головну!</a>
        </div>
      </div>
...
<ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/admink/course/1/remote" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
...
<script src="<?php echo e(asset('public/plugins/jqvmap/maps/jquery.vmap.world.js')); ?>"></script>
<!-- jQuery Knob Chart -->
...
</html><?php /**PATH /home/alex/www/diplom/resources/views/admink/layouts/app_admink.blade.php ENDPATH**/ ?>