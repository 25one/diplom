...
<head>
  ...
  <link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700" rel="stylesheet">
   <link rel="stylesheet" href="<?php echo e(asset('dist/css/datatables.css')); ?>">
   </header>
...
<ul class="nav justify-content-end">
    <li class="nav-item">
<a class="nav-link active" href="<?php echo e(asset('user_profile')); ?>">Особисті данні</a>
</li>
</ul>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="<?php echo e(asset('students')); ?>"  class="d-block">
          На головну!</a>
        </div>
      </div>
      <ul class="nav justify-content-end">
...
<li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo e(asset('memoris')); ?>" class="nav-link">
              ...
              <li class="nav-item">
                <a href="<?php echo e(asset('skills')); ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
        ...
        <ul class="nav nav-treeview">
          <li class="nav-item">
                <a href="<?php echo e(asset('operational')); ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
...
<li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo e(asset('skillsplan')); ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Очна частина</p>
                </a>
              </li>
      ...
      <ul class="nav nav-treeview">
                ...
                <a href="#" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Лекції та семінари </p>
                </a>
              </li>
            </ul> 
<ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo e(asset('inputformsday')); ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
              ...
              <li class="nav-item">
                <a href="<?php echo e(asset('formssurgeryday')); ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
              ...
              <li class="nav-item">
                <a href="<?php echo e(asset('formspracticeday')); ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Практичні навички </p>
                </a>
              </li>
               ...
               <li class="nav-item">
                <a href="<?php echo e(asset('nightworkday')); ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
...
</html><?php /**PATH /home/alex/www/diplom/resources/views/layouts/base.blade.php ENDPATH**/ ?>